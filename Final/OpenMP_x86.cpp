...
void search_element_bit_omp(int *query, vector<index> &idx, int num)
{
    int i, j, t, l;
    vector<index> t_idx;
    for (i = 0; i < num; i++)
...
void search_list_SIMD_SSE_omp(int *query, vector<index> &idx, int num)
{
    int i, j, o, r;
    vector<index> t_idx;
    for (i = 0; i < num; i++)
...
void search_list_SIMD_AVX_omp(int *query, vector<index> &idx, int num)
{
    int i, j, o, r;
    vector<index> t_idx;
    for (i = 0; i < num; i++)
